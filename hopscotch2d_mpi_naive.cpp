// hopscotch2d_mpi_naive.cpp
// Equação do calor 2D (Hopscotch) — versão MPI puro com block tiling.
// - Decomposição 2D por MPI (cartesiana PxQ), halo de 1 célula em cada lado
// - Sem OpenMP: cada rank executa localmente os tiles da sua submalha
...
//
// Compilar:
//   mpicxx -O3 -march=native -DOMPI_SKIP_MPICXX=1 -DMPICH_SKIP_MPICXX=1 \
//          hopscotch2d_mpi_naive.cpp -o hopscotch2d_mpi_naive
//
// Executar (exemplo):
//   mpirun -np 192 ./hopscotch2d_mpi_naive
...
int main(int argc, char** argv) {
    ...
    if (cart_rank==0) counts.resize(world_size);
