// hopscotch2d_omp_ews.cpp
// Equação do calor 2D (Hopscotch) — OpenMP com divisão explícita do domínio (faixas contíguas)
// e sincronização GLOBAL por fase via `#pragma omp barrier` (sem sincronização local vizinho-a-vizinho).
...
int main() {
    ...
    #pragma omp parallel default(shared)
    {
        ...
        // Sincronização GLOBAL por fase (barreira) — sem estruturas de sincronização local.
        ...
        for (int step=0; step<T; ++step) {
            ...
            // Barreira global ao final da FASE 1
            #pragma omp barrier
            ...
            // Barreira global ao final da FASE 2
            #pragma omp barrier
            ...
            // Barreira global ao final da FASE 3
            #pragma omp barrier
