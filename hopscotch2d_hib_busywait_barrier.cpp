// hopscotch2d_hib_busywait_barrier.cpp
...
//          hopscotch2d_hib_busywait_barrier.cpp -o hopscotch2d_hib_busywait_barrier -lm
...
int main(int argc, char** argv)
{
    ...
    #pragma omp parallel default(none) shared(N,T,TILE,lam,denom,U_new,U_old,L,local_n,start_g,up,down,COMM,progress,unew_up_ready,unew_down_ready,uold_up_ready,uold_down_ready)
    {
